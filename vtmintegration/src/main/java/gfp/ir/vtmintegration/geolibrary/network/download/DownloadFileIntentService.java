package gfp.ir.vtmintegration.geolibrary.network.download;
...
import gfp.ir.vtmintegration.geolibrary.core.dialogs.ProgressBarDialogFragment;
import gfp.ir.vtmintegration.geolibrary.network.NetworkUtilities;
import gfp.ir.vtmintegration.geolibrary.util.TimeUtilities;

import static gfp.ir.vtmintegration.geolibrary.network.download.DownloadResultReceiver.PROGRESS_ENDED_KEY;
import static gfp.ir.vtmintegration.geolibrary.network.download.DownloadResultReceiver.PROGRESS_ERRORED_KEY;
import static gfp.ir.vtmintegration.geolibrary.network.download.DownloadResultReceiver.PROGRESS_KEY;
import static gfp.ir.vtmintegration.geolibrary.network.download.DownloadResultReceiver.PROGRESS_MESSAGE_KEY;
import static gfp.ir.vtmintegration.geolibrary.network.download.DownloadResultReceiver.max;
