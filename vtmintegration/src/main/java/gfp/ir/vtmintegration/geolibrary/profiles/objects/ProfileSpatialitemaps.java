 ...
 */
package gfp.ir.vtmintegration.geolibrary.profiles.objects;

import android.os.Parcel;
import android.os.Parcelable;

import  gfp.ir.vtmintegration.geolibrary.network.download.IDownloadable;

/**
 * Created by hydrologis on 19/03/18.
 */
public class ProfileSpatialitemaps extends ARelativePathResource implements Parcelable, IDownloadable {
    public String url = "";
