...
public abstract class AbstractSpatialDatabaseHandler implements AutoCloseable {
    ...
    * @return defaultZoom
     ...
     * @return the list of {@ link gfp.spatilite_core.core.tables.SpatialVectorTable}s.
     ...
     *
     * @param forceRead force a clean read from the db instead of using cached.
     * @return the list of {@ link gfp.spatilite_core.core.tables.SpatialRasterTable}s.
     * @throws Exception  if something goes wrong.
     */
    ...
    */
     ...
     * 
     * @param spatialTable the {@ link gfp.spatilite_core.core.tables.AbstractSpatialTable}.
