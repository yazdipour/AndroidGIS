 ...
 */
package gfp.ir.vtmintegration.spatilite_core.util.database;
...
import gfp.ir.vtmintegration.geolibrary.util.debug.Debug;
...
//            DaoImages.createTables();
            //FIXME:here a list of necessary tables are generated
        }
