 ...
 */
package gfp.ir.vtmintegration.spatilite_core.core.tables;
...
import gfp.ir.vtmintegration.geolibrary.style.ColorUtilities;
...
import static gfp.ir.vtmintegration.spatilite_core.util.SpatialiteUtilities.UNIQUENAME_SEPARATOR;
...
public class SpatialVectorTable extends AbstractSpatialTable implements Serializable {
    ...
    public List<String> getdistinctfield(String Field){
        ...
        List<String> distinctfield;

     public String getThemeField()

     {
         return this.style.themeField;

     }

        public void setThemeField(String Field)
        {
            this.style.themeField=Field;
        }

    public void setdistinctfield(List<String> fieldvalues){

        distinctfield=fieldvalues;

    }
    EDataType styleFieldType;
    public void setStyleFieldType(EDataType type){
         styleFieldType=type;
        }

        public EDataType getStyleFieldType(){
         return styleFieldType;
        }
