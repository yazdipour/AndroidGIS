...
import gfp.ir.vtmintegration.spatilite_core.core.mbtiles.MBTilesDroidSpitter;
import gfp.ir.vtmintegration.spatilite_core.core.mbtiles.MBtilesAsync;
import gfp.ir.vtmintegration.spatilite_core.core.mbtiles.MbTilesMetadata;
...
public class MbtilesDatabaseHandler extends AbstractSpatialDatabaseHandler {
     ...
     */
    public List<AsyncTasks> asyncTasksList = new ArrayList<AsyncTasks>();
...
//     * @param tile_bitmap  retrieve the Bitmap as done in 'CustomTileDownloader'
     ...
     */
    public ByteArrayInputStream getBitmapTile(int i_x, int i_y_osm, int i_z, int i_pixel_size) {
        ...
        rasterBytes = mbtilesSplitter.getTileAsBytes(i_x, i_y_osm, i_z);
        ...
        ByteArrayInputStream bs = new ByteArrayInputStream(rasterBytes);
        return bs;
    ...
    public ByteArrayInputStream getBitmapTile(int i_x, int i_y_osm, int i_z, int i_pixel_size,boolean istms) {
        ...
        rasterBytes = mbtilesSplitter.getTileAsBytes(i_x, i_y_osm, i_z,istms);
    ...
    /**
     * Returns name of dataset based on metadata Table
     *
     *
     * @return Name as String, it may return Null if name is not set
     */
