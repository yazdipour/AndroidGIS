package gfp.ir.vtmintegration.spatilite_core.core.resourcestorage;

/**
 * @author Cesar Martinez Izquierdo (www.scolab.es)
 */
public class BlobResource extends gfp.ir.vtmintegration.spatilite_core.core.resourcestorage.Resource {
