 ...
 */
package gfp.ir.vtmintegration.spatilite_core.core.mbtiles;
...
import gfp.ir.vtmintegration.spatilite_core.core.mbtiles.MbTilesMetadata.MetadataParseException;
import gfp.ir.vtmintegration.spatilite_core.core.mbtiles.MbTilesMetadata.MetadataValidator;
...
//        }
    ...
    // -----------------------------------------------
    public byte[] getTileAsBytes(int i_x, int i_y_osm, int i_z,boolean istms) {
        int i_y = i_y_osm;
        String s_x = "";
        String s_y = "";
        String s_z = "";
     ...
     * @return byte[] of the tile to be used to create a Bitmap or null if no tile matched the given parameters
     */
    public byte[] getTMSTileAsBytes(int i_x, int i_y_osm, int i_z) {
        int i_y = i_y_osm;
        String s_x = "";
        String s_y = "";
        String s_z = "";
