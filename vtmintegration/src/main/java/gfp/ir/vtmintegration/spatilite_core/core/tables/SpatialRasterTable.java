...
public class SpatialRasterTable extends gfp.ir.vtmintegration.spatilite_core.core.tables.AbstractSpatialTable implements Serializable {
    ...
    public SpatialRasterTable( String dbPath, String name, String srid, int minZoom, int maxZoom, double centerX, double centerY,
        ...
        super(dbPath, name, ESpatialDataSources.DB.getTypeName(), srid, minZoom, maxZoom, centerX, centerY, bounds);
