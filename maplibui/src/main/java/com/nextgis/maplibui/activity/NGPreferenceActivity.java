...
/**
 * Base class for NextGIS preferences editor.activity
 */
        ...
        implements PreferenceFragmentCompat.OnPreferenceStartScreenCallback
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Create the com.editor.fragment only when the com.editor.activity is created for the first time,
    ...
    {
        // TODO: for isMultiPane() change title of Settings editor.fragment, not of Activity
